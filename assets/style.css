...
index 3d6f922d82cae425ab7f8fec4626d8f55aca64b7..b2b443832913d8bc12da9fb5dbcbf0afb688ff3e 100644
--- a/assets/script.js
+++ b/assets/script.js
@@ -1,158 +1,178 @@
...
@@ -253,243 +273,253 @@ async function cekSantri(force = false) {
...
@@ -592,51 +622,50 @@ function showDetail(index) {
       </div>
     `
       : ""
   }
...
-
 ...
 Data yang benar:
 (Tulis di sini)
@@ -655,457 +684,487 @@ function setupFloatingScrollHint() {
...
@@ -1137,126 +1196,139 @@ function setupSliderButtons() {
       } else {
...
@@ -1272,117 +1344,183 @@ async function loadRekomData() {
...
@@ -1460,395 +1598,452 @@ function openRekomFilterPanel() {
...
@@ -1882,34 +2077,38 @@ function renderRekomPeriod(label, alpa, status, overallSelesai = false) {
